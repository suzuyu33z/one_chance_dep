...
export default function UserWalkListPage() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      // ログインしている場合のみデータを取得
      fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/all_user_walks`, {
        method: "GET",
        headers: {
          ...
          <div className="w-full mt-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center bg-white shadow-md rounded-lg p-4 hover:shadow-lg transition-shadow duration-300">
                ...
                <img
                  src="/images/popular_dog3.png"
                  alt="Popular Dog 3"
                  className="w-14 h-14 object-cover rounded-full mr-4"
                />
                <div className="flex-1">
                  <h4 className="text-lg font-medium text-gray-800">
                    ポッキー（登録１０００人越え大感謝キャンペーン中！）
                  </h4>
          ...
          <div className="w-full mt-8">
            ...
            <div className="flex space-x-4 overflow-x-auto">
              <div className="bg-white shadow-md rounded-lg p-3 hover:shadow-lg transition-shadow duration-300 w-28">
                ...
                />
                <h4 className="text-xs font-medium mt-2 text-gray-800 text-center">
                  トフィー <span className="text-red-500 italic">NEW!</span>
                </h4>
              ...
              <div className="bg-white shadow-md rounded-lg p-3 hover:shadow-lg transition-shadow duration-300 w-28">
                ...
                />
                <h4 className="text-xs font-medium mt-2 text-gray-800 text-center">
                  ベル <span className="text-red-500 italic">NEW!</span>
                </h4>
